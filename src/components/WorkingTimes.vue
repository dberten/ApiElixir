...
<template>
	...
	<div class="container p-0 mb-4">
		<div class="d-sm-flex justify-content-between align-items-center">
			<DatePicker class="calendar" :value="null" color="green" is-dark is-range v-model="wTimes" />
	...
	<div v-for="aWtime in wTimes" :key="aWtime.id">
		<div class="container p-0 mb-4 text-color-Wsoft d-md-flex align-items-center wt-backBox black-soft rounded">
